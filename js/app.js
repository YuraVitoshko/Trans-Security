(() => {
            ...
            (function(factory) {
                ...
                return function() {
                    ...
                    var defaults = {
                        ...
                        showFlags: true,
                        useFullscreenPopup: /Android.+Mobile|webOS|iPhone|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) || window.innerWidth <= 500,
                        utilsScript: ""
                    };
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".category-our-fleet__slider")) {
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            subMenus.forEach((function(menuItem) {
                menuItem.addEventListener("click", (function(event) {
                    ...
                    if (submenu.classList.contains("active")) submenu.classList.remove("active"); else {
                        closeAllSubmenus();
            ...
            function closeAllSubmenus() {
                subMenus.forEach((function(menuItem) {
                    menuItem.querySelector(".menu__sub-list").classList.remove("active");
                }));
            }
        }));
